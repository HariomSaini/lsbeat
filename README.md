...
```
git remote set-url origin https://github.com/HariomSaini/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/HariomSaini
cd ${GOPATH}/github.com/HariomSaini
git clone https://github.com/HariomSaini/lsbeat
```
